...
**4.1 ลงทะเบียนผู้ยืม** — ฟอร์มลงทะเบียน (ชื่อ, เลขบัตร ปชช., ที่อยู่, รูปอาการป่วย, คำอธิบาย) ตรวจสอบเลขบัตร 13 หลักด้วย checksum จริงของไทย รูปอาการป่วยแนบได้แต่ไม่บังคับ และ**ไม่เก็บรูปบัตรประชาชน** (สำเนาบัตรอีกใบไม่ได้ช่วยตัดสินใจอะไร) บันทึก timestamp อัตโนมัติ เลขบัตรประชาชน**เข้ารหัส AES-256-GCM**ก่อนเก็บ (คีย์มาจาก `ENCRYPTION_KEY`) หน้าจอทั่วไปแสดงเลขบัตรแบบ mask (เช่น `110xxxxxxx366`) ต้อง login ก่อนถึงจะเห็นเลขเต็มและรูปภาพ
